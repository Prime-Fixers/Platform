# Dockerfile for FrostLinkPlatform.API
# Summary: 
# This Dockerfile builds and runs the CatchUpPlatform.API application using .NET 9.0
# Description:
# This Dockerfile is designed to create a Docker image for the FrostLinkPlatform.API application.
...
COPY FrostLinkPlatform.API/*.csproj FrostLinkPlatform.API/
# Restore dependencies
RUN dotnet restore ./FrostLinkPlatform.API
# Copy the rest of the application files
COPY . .

# Step 2: Deploy the application to builder stage
# Publish the application in Release mode
RUN dotnet publish ./FrostLinkPlatform.API -c Release -o out
...
ENTRYPOINT ["dotnet", "FrostLinkPlatform.API.dll"]